...
def _parse_notice(raw: dict, kind: str) -> dict:
    ...
    return {
        ...
        "rcrit_de": _norm_date(_field(raw, "RCRIT_PBLANC_DE")),
        "rcept_bgnde": _norm_date(_field(raw, "RCEPT_BGNDE",
                                         "SUBSCRPT_RCEPT_BGNDE")),
        "rcept_endde": _norm_date(_field(raw, "RCEPT_ENDDE",
                                         "SUBSCRPT_RCEPT_ENDDE")),
        "przwner_de": _norm_date(_field(raw, "PRZWNER_PRESNATN_DE")),
        "cntrct_bgnde": _norm_date(_field(raw, "CNTRCT_CNCLS_BGNDE")),
        "cntrct_endde": _norm_date(_field(raw, "CNTRCT_CNCLS_ENDDE")),
